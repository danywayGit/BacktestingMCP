...
# ── CONFIG_V13_0 — Auto-Evolved: LLM-suggested parameters ──
# Generated by auto-evolver. Uses higher ADX (25), RSI range (25-65),
# volume divergence + smart money index for confirmation.
CONFIG_V13_0 = ScoringConfig(
    version="13.0",
    description="Auto-Evolved: LLM-suggested. High ADX (25), RSI range (25-65), volume divergence + SMI confirmation.",
    # Weights
    trend_weight=0.5,
    volume_relative_weight=0.2,
    signal_feed_weight=0.2,
...
CONFIG_V7_2 = ScoringConfig(
    version="7.2",
    status="disabled",  # DISABLED Sep 2026 (Didier): WR 46.2% < 50%
...
CONFIG_V7_3 = ScoringConfig(
    version="7.3",
    status="disabled",  # DISABLED Sep 2026 (Didier): WR 33.3% < 50%
...
CONFIG_V7_4 = ScoringConfig(
    version="7.4",
    status="disabled",  # DISABLED Sep 2026 (Didier): WR 46.7% < 50%
...
CONFIG_V7_5 = ScoringConfig(
    ...
    status="disabled",  # DISABLED Sep 2026 (Didier): WR 45.0% < 50%
    min_abs_score=6.5,
    min_adx=18,
    min_rsi=25,
    max_rsi=75,
...
CONFIG_V7_6 = ScoringConfig(
    ...
    status="disabled",  # DISABLED Sep 2026 (Didier): WR 42.2% < 50%
    min_abs_score=6.5,
    min_adx=18,
    min_rsi=28,
    max_rsi=72,
...
CONFIG_V7_7 = ScoringConfig(
    version="7.7",
    description="LLM-evolved: relaxed ADX/ATR/RSI filters [DISABLED — 20.0% WR, losing money]",
    status="disabled",
    min_abs_score=6.5,
    min_adx=18,
    min_rsi=25,
